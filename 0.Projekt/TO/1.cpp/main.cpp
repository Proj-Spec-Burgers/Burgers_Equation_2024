...
void DemoParDiffEq1()
{
	ParDiffEq1Euler eq1_eul(h, k);
	eq1_eul.Euler();

	ParDiffEq1RK2 eq1_rk2(h, k);
	eq1_rk2.RK2();
}
void DemoParDiffEq2()
{
	ParDiffEq2Euler eq2_eul(h, k);
	eq2_eul.Euler();

	ParDiffEq2RK2 eq2_rk2(h, k);
	eq2_rk2.RK2();
}
void DemoParDiffEq3()
{
	ParDiffEq3Euler eq3_eul(h, k);
	eq3_eul.Euler();

	ParDiffEq3RK2 eq3_rk2(h, k);
	eq3_rk2.RK2();

	ParDiffEq3Implicit eq3_implicit(h, k);
	eq3_implicit.Implicit();
}
void DemoBurgersEq()
{
	ParDiffEqBurgersEuler Burgers_eul(h, k);
	Burgers_eul.Euler();

	ParDiffEqBurgersRK2 Burgers_rk2(h, k);
	Burgers_rk2.RK2();

	ParDiffEqBurgersImplicit Burgers_implicit(h, k);
